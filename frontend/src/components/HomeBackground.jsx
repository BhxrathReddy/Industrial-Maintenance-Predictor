...
import { HoverBorderGradientDemo } from "./buttton";
    ...
    return (
        <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
            <h2
                ...
                Industrial Maintenance, <br /> Predictor.
            </h2>
            <p
                className="max-w-xl mx-auto text-sm md:text-lg text-neutral-700 dark:text-neutral-400 text-center">
                Our affordable AI tool uses sensor readings to predict the probability of machine failure for small and medium manufacturers. This allows operators to schedule preventive maintenance and avoid unexpected, costly breakdowns.            </p>
